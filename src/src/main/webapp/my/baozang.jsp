...
<script id="baozang-item" type="text/x-jquery-tmpl">
		{{each(i,data) datas}}
			<div style="margin-bottom:10px" class="col-xs-6 col-md-6 item-image"><a href="./baozangDetail.jsp?id=${data.id}" class="col-xs-5 col-md-5"><img class="btn btn-link baozang" name="${data.id}" src="../assets/img/ny_03.png"></a><span class="col-xs-7 col-md-7">${data.id}<br>${data.desc}</span></div>
		{{/each}}
